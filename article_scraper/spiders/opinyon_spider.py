...
class PSNSpider(scrapy.Spider):
    name = 'opinyon'
    start_urls = ['https://www.philstar.com/micro_page.php?qcount=1&micro=104&page=1&cell=2&lastid=2205420']
    ...
    def parse_articles(self, response):
        yield {
            ...
            'summary': clean(' '.join(response.css(".article__writeup > p:first-child *::text").getall())).strip(),
